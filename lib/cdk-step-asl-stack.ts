...
export class CdkStepAslStack extends cdk.Stack {
    constructor(scope: cdk.Construct, id: string, props: StateMachineProps) {
        ...
        const getTranscriptionText = new tasks.CallAwsService(this, "GetTranscriptionText", {
            service: 's3',
            action: 'getObject',
            parameters: {
                Bucket: bucket.bucketName,
        ...
        const isTransactionDone = new sfn.Choice(this, "IsTransactionDone?").when(sfn.Condition.stringEquals('$.TranscriptionJob.TranscriptionJobStatus', 'COMPLETED'), getTranscriptionText ).otherwise(wait20Seconds).afterwards()
        ...
        const startTextTranslation = new tasks.CallAwsService(this, "StartTextTranslation", {
            service: 'translate',
